...
async function loadPages() {
    try {
        ...
        pages.forEach((page, index) => {
            ...
            pageElement.dataset.id = page._id;
...
function updateMediaList(images = [], videos = []) {
    ...
    allMedia.forEach((media, index) => {
        ...
        mediaItem.dataset.id = media._id;
        ...
        console.log(`Medya öğesi eklendi (${index + 1}/${allMedia.length}):`, media.type, media._id);
    });
